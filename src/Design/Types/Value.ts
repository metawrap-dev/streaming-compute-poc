...
export type Value<T, D extends Dimension> =
  | Vector<T | IData<T, Dimension.Scalar, 1>, D> // Allows using either basic types or wrapped data types as vector elements. The 1 denotes that it is a single entity.
